...
public class CodeGeneratorUtils {
    public static void main(String[] args) {
        ...
        globalConfig
                ...
                .setAuthor(System.getProperty("Jay"))// 设置作者名字
        ...
        dataSourceConfig
                .setUrl("jdbc:mysql://localhost:3306/homework01?characterEncoding=utf-8&serverTimezone=Asia/Shanghai")
        ...
        packageConfig
                .setParent("com.shenzhijie.loguserinfo.generator")
                .setEntity("entity")
        ...
        strategyConfig
                ...
                .setInclude("shen_test_table_copy")// 设置要映射的表
